...
- [x] 1.1 Create `docs/framework/` with a `README.md` overview: the three-layer
  ...
  throughout
- [x] 1.2 Add the cross-link convention up front (per design D3): the playbook cites
...
- [x] 2.1 `docs/framework/layer-1-convergence-machine.md` from
...
- [x] 2.2 `docs/framework/layer-2-dispatch-and-deployment.md` from
...
- [x] 2.3 `docs/framework/layer-3-operator-discipline.md` from
...
- [x] 3.1 `docs/framework/quickstart.md` — the one-page "answer-once defaults" a new
...
- [x] 3.2 Add the three pre-action checklists (background a job / reproduce a failure
